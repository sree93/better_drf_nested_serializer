...
class NestedDataHelper:
    ...
    def __init__(self):
        ...
        self._model_cache: Dict[Type[Model], Iterable[Model]] = {}
    ...
    def get_serializer(self, field_name):
        return self.get_serializer_class(field_name)(**self.get_serializer_kwargs(field_name))
    ...
    def add(
            self, field_name: str, model_class: Type[Model], serializer_class: Type[serializers.Serializer],
            kwargs: Dict = None, append_to_instance_cache: Iterable[Model] = None
    ):
        if kwargs is None:
            kwargs = {}

        self._mapping__field_info[field_name] = NestedData(model_class, serializer_class, kwargs)
